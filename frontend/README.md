...
Files
1. `index.html`
   - Dashboard markup, recent-session list, playback panel, suppression preview controls, waveform and spectrogram previews, and result containers.
2. `styles.css`
...
3. `app.js`
   - Upload flow, saved-session loading, per-class suppression profile requests, original-versus-processed playback comparison, waveform and spectrogram decoding, and interactive playback/timeline behavior.
